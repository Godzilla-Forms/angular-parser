...
export class GodzillaFormsParserComponent implements OnChanges {
  ...
  constructor(private formBuilder: FormBuilder,
              private httpService: GodzillaFormService,
              private godzillaLoader: GodzillaLoaderService) {
  }
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    } else if (this.jsonForm) {
      this.form = JSON.parse(this.jsonForm) as GodzillaForm;
      this.createPages(this.form.pages);
    }
  }
  ...
  private fetchForm(formId: string) {
    this.httpService.fetchForm(formId).subscribe((form) => {
      this.form = form;
      this.createPages(this.form.pages);
    });
  }
